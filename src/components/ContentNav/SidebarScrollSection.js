...
import SidebarSection from './ContentNavSection'
...
class SidebarScrollSection extends Component {
  ...
  render() {
    ...
    return <SidebarSection isScrollSync activeItemId={activeItemId} {...this.props} />
  }
}

export default SidebarScrollSection
